...
.factory('BLE', function($q) {
  ...
  return {
    ...
    startNotification: function(device, service, characteristic, success, failure) {
      ble.startNotification(device, service, characteristic, function(data) {
        var converted = String.fromCharCode.apply(null, new Uint8Array(buffer));
        success(converted);
      }, failure);
    }
  };
